...
- (void)timingHideBottomBarTime {
    ...
    [self performSelector:@selector(hideReplayBtn) withObject:nil afterDelay:0];
...
- (void)videoTopBarDidClickCloseBtn {
    ...
    if ([self.delegate respondsToSelector:@selector(closeBtnPress)]) {
        [self.delegate closeBtnPress];
    }
}
